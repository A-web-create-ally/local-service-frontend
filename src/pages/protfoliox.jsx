...
import Hero from "../pages/Heroportfolio"; 
  ...
  {portfolioData
    ...
    .map((item, index) => (
      ...
      >
        ...
        <div className="portfolio-content h-100 custom-card">
          ...
          <div className="portfolio-info">
            ...
            <p>
              Trusted professionals providing quality home services
              with fast response and affordable pricing.
            </p>
